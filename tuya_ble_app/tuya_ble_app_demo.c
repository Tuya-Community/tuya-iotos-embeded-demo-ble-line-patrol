...
static const char auth_key_test[] = "ebTbUugxUcZAJmaJxvJ1y8MQFaj6Jpiw";
static const char device_id_test[] = "tuya53ea8557e3c5";
static const uint8_t mac_test[6] = {0xCD,0x2F,0x31,0x4D,0x23,0xDC}; //The actual MAC address is : DC234D312FCD
